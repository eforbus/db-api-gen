...
const (
	// Label holds the string label denoting the deptemployee type in the database.
	Label = "dept_employee"
	...
	// Table holds the table name of the deptemployee in the database.
	Table = "dept_employee"
	// EmployeeTable is the table that holds the employee relation/edge.
	EmployeeTable = "dept_employee"
...
// Columns holds all SQL columns for deptemployee fields.
var Columns = []string{
	FieldID,
	FieldEmployeeID,
	FieldDepartmentID,
...
// OrderOption defines the ordering options for the DeptEmployee queries.

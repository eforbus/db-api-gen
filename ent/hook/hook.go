...
// The DeptEmployeeFunc type is an adapter to allow the use of ordinary
// function as DeptEmployee mutator.
type DeptEmployeeFunc func(context.Context, *ent.DeptEmployeeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeptEmployeeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DeptEmployeeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DeptEmployeeMutation", m)
}

// The DeptManagerFunc type is an adapter to allow the use of ordinary
// function as DeptManager mutator.
type DeptManagerFunc func(context.Context, *ent.DeptManagerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeptManagerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DeptManagerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DeptManagerMutation", m)
}
...
func (f SalaryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SalaryMutation); ok {
		return f(ctx, mv)
	}

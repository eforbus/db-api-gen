...
// HasDeptEmployees applies the HasEdge predicate on the "dept_employees" edge.
func HasDeptEmployees() predicate.Employee {
...
// HasDeptEmployeesWith applies the HasEdge predicate on the "dept_employees" edge with a given conditions (other predicates).
func HasDeptEmployeesWith(preds ...predicate.DeptEmployee) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := newDeptEmployeesStep()
...
// HasDeptManagers applies the HasEdge predicate on the "dept_managers" edge.
func HasDeptManagers() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasDeptManagersWith applies the HasEdge predicate on the "dept_managers" edge with a given conditions (other predicates).
func HasDeptManagersWith(preds ...predicate.DeptManager) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := newDeptManagersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasSalaries applies the HasEdge predicate on the "salaries" edge.
func HasSalaries() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSalariesWith applies the HasEdge predicate on the "salaries" edge with a given conditions (other predicates).
func HasSalariesWith(preds ...predicate.Salary) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := newSalariesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasTitles() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTitlesWith(preds ...predicate.Title) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := newTitlesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {

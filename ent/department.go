...
func (e DepartmentEdges) DeptEmployeesOrErr() ([]*DeptEmployee, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading.
func (e DepartmentEdges) DeptManagersOrErr() ([]*DeptManager, error) {
	if e.loadedTypes[1] {
...
func (*Department) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case department.FieldID, department.FieldName:
...
// QueryDeptEmployees queries the "dept_employees" edge of the Department entity.
func (d *Department) QueryDeptEmployees() *DeptEmployeeQuery {
	return NewDepartmentClient(d.config).QueryDeptEmployees(d)
}

// QueryDeptManagers queries the "dept_managers" edge of the Department entity.
func (d *Department) QueryDeptManagers() *DeptManagerQuery {
	return NewDepartmentClient(d.config).QueryDeptManagers(d)
}

...
func HasDeptEmployees() predicate.Department {
...
func HasDeptEmployeesWith(preds ...predicate.DeptEmployee) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
...
func HasDeptManagers() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasDeptManagersWith(preds ...predicate.DeptManager) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
